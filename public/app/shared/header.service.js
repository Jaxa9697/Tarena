...
var HeaderService = (function () {
    ...
    HeaderService.prototype.getClientsByVlan = function (vlan) {
        return this.http.get('/getClientsByVlan?id=' + vlan.id.toString())
            ...
            var quantity = 253 - Number(vlan.subnetMask.split(".")[3]);
